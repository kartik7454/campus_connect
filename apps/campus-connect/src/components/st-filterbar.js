...
<div className="bg-slate-300 w-96 ml-28 px-2 rounded-lg py-5">
  <h1 className="font-bold text-2xl capitalize text-center mb-5 " >filter</h1>  
 
    
    <div className="h-10  mb-2 bg-slate-400 overflow-hidden hover:h-auto rounded ">
...
<div id="dropdown" className="z-10 w-44 bg-white divide-y divide-gray-100 rounded-lg shadow  dark:bg-gray-700">
    <input className="w-44" type="date"id="0" onChange={((e)=>{handelclick(e.target.value,e.target.id)})}></input>
...
<button onClick={  ()=>{reset()} } id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white mt-2  w-full  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  text-center inline-flex items-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-blue-800" type="button">remove filters 
</button>
</div>
